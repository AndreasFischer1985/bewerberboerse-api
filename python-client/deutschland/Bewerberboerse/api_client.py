...
from deutschland.Bewerberboerse import rest
...
from deutschland.Bewerberboerse.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.bewerberboerse  # this is an instance of the class Endpoint
        api_instance.bewerberboerse()  # this invokes api_instance.bewerberboerse.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.bewerberboerse.callable or self.callable in this class
